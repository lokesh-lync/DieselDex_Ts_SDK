...
export type DieselAmmContractConfigurables = Partial<{
...
export class DieselAmmContractInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class DieselAmmContract extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: DieselAmmContractInterface;
  declare functions: {
